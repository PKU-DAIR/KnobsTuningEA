...
from autotune.workload import SYSBENCH_WORKLOAD, JOB_WORKLOAD
from autotune.workload import OLTPBENCH_WORKLOADS
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='', help='surrogate model path')
